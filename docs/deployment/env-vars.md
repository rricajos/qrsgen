...
|---|---|---|
| `QRSGEN_VERSION` | `0.45.0` | Tag de imagen Docker (`qrsgen:${QRSGEN_VERSION}`). Última versión: v0.45.0 (template configurable del header de sender vía `QRSGEN_HEADER_TEMPLATE` + reactions partidas en header/body como los group msgs). |
| `POSTGRES_PORT` | `5432` | |
| `POSTGRES_DB` | `bridge` | |
