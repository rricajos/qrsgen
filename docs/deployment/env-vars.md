...
|---|---|---|
| `QRSGEN_VERSION` | `0.45.1` | Tag de imagen Docker (`qrsgen:${QRSGEN_VERSION}`). Última versión: v0.45.1 (reactions tienen separador propio `QRSGEN_REACTION_HEADER_SEP`, default `\n` — más compacto que el `\n\n` de group msgs). |
| `POSTGRES_PORT` | `5432` | |
| `POSTGRES_DB` | `bridge` | |
