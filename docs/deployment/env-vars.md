...
|---|---|---|
| `QRSGEN_VERSION` | `0.50.0` | Tag de imagen Docker (`qrsgen:${QRSGEN_VERSION}`). Última versión: v0.50.0 (group admin completeness — 5 endpoints adicionales: topic, locked, announce, create, leave). |
| `POSTGRES_PORT` | `5432` | |
| `POSTGRES_DB` | `bridge` | |
